...
class UnitigData : public CCDBG_Data_t<UnitigData>, CDBG_Data_t<UnitigData> {
    ...
    public:
        ...
        inline void set_on_target_path() { b = TARGET; } //set boolean to "visited and on target path"
        ...
        inline bool is_on_target_path() { return (b == TARGET); }
        inline bool is_not_on_target_path() { return (b != TARGET); }
    ...
    private:
        ...
        const static uint8_t TARGET = 0x3;
